...
//Notify
$.notify({
    icon: "{{ url_for('static', filename='images/Qanciye.png') }}", // Correct path syntax
    title: '<strong>Qancive Construction And General Services</strong>',
    message: 'Welcome to Qancive Construction And General Services Co., High Quality Construction Services.'
}, {
    type: 'secondary',
    placement: {
        from: "bottom",
    ...
    template: '<div data-notify="container" class="alert alert-{0}" role="alert">' +
        '<img data-notify="icon" src="{3}" class="img-circle" style="width:40px;height:40px;margin-right:10px;">' +
